...
public class Controle {
	...
	private void metodoControle() {
	}

	private void metodoControle2(String p1) {
		System.out.println("Controle.metodoControle2(String p1)");
		System.out.println("Parâmetro obtido: " + p1);
	}

	private void metodoControle2(String p1, String p2) {
	...
	private void metodoControle2(String p1, Integer p2) {
